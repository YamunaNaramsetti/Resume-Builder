...
let skills=document.getElementsByClassName('skill')
  ...
  return(
    ...
    <HStack id='wrap' marginBottom={'5vh'}>
      ...
      <VStack height={'125vh'} className='wide' w={'50%'}  bg={'white'} overflow={'scroll'}>
        <HStack color={'white'} className='wide' w={'50%'} zIndex={'1'}  justifyContent={'space-around'} >
        ...
        <Live data={data} name={'Yamuna'} file={uploadedFile} />
</HStack>
