...
function Live(props) {
  ...
  return (
    ...
    <HStack h={'100%'} ref={componentRef}>
        <VStack h={'100%'} w={'40%'} color={'white'} p={6} alignItems={'flex-start'} bg="black">
            ...
            <Text className='head' fontWeight={'bold'} color="white">ABOUT ME</Text>
            <Text color="black">{props.data.me}</Text>
            <div className="hline"></div>
            <Text className='head' fontWeight={'bold'} color="white">SKILLS</Text>
            <Text color="white">{props.data.skill0}</Text>
            <Text color="white">{props.data.skill1}</Text>
            <Text color="white">{props.data.skill2}</Text>
            <Text color="white">{props.data.skill3}</Text>
            
            <div className="hline"></div>
            <Text className='head' fontWeight={'bold'} color="white">CONTACT</Text>
            <HStack>
                <Phone/><Text color="white">{props.data.phone}</Text>
            </HStack>
            <HStack>
                <Map/><Text color="white">{props.data.address}</Text>
            </HStack>
            <HStack>
                <Mail/><Text color="white">{props.data.email}</Text>
            </HStack>
            
        </VStack>

        <VStack h={'100%'} w={'60%'} p={8} alignItems={'flex-start'}>
            <Text w={'full'} className='high' color="black">WORK EXPERIENCE</Text>
            {
                exp.map((item,id)=>{
    ...
    <Link to={'/downloaded'} >
    <Button bg="violet" borderRadius={10} borderWidth={0} onClick={handlePrint}>Print</Button>
    </Link>
    </VStack>
